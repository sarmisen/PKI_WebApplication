<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Symmetric.aspx.cs" Inherits="PKI_WebApplication.Symmetric" %>
...
<body>
    ...
    <div>
        <h1>Ejemplo Encriptación Simétrica</h1>
        ...
        <div style="margin-top: 10px; background-color: #ccc;">
            ...
            <div style="float:left; width: 400px; padding: 5px"><asp:TextBox ID="tbCypherText" runat="server" Width="100%"></asp:TextBox></div>
            ...
            <div style="float: left; width: 150px; padding: 5px;">IV</div>
            <div style="float:left; width: 400px; padding: 5px"><asp:TextBox ID="tbIV" runat="server" Width="100%"></asp:TextBox></div>
            <div style="clear: both;"></div>
        </div>
